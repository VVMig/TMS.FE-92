...
const UsersWithEducation = <Type extends HasEducation>(arr: Type[]): Type[] => {
...
const UsersWithAnimals = (arr: IUsers[]): IUsers[] => {
...
class Book {
  constructor(private name: string, private author: string, private year: number){}
